...
class SumAddCommandTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testObject = SumAddCommand( calculatorEngine: engine, display : display, registerController : registerController)
    ...
    func testAnotherMultipleAddEntries(){
        ...
        XCTAssertEqual(registerController.register[5],31.01, accuracy:0.01)
        XCTAssertEqual(registerController.register[6],200.49, accuracy:0.01)
        XCTAssertEqual(registerController.register[7],1415)
    }
}
